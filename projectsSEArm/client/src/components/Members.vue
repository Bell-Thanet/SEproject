...
<template>
  ...
  >
    <v-navigation-drawer
      absolute
      dark
      src="https://images.wallpaperscraft.com/image/hand_palm_fingers_130790_2560x1080.jpg"
      width="100%"
      permanent
    >
  ...
  getProvince() {
   ...
   saveData() {
    ...
    clear() {
        ...
        this.JobPost.nametypes = null;
        this.JobPost.genders = null;
        this.JobPost.provinces = null;
    },
